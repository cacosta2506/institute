...
@ManagedBean(name = "evaluacionInfraestructuraController")
public class EvaluacionInfraestructuraController implements Serializable {
    ...
    private static final Logger LOG = Logger
	    .getLogger(EvaluacionInfraestructuraController.class
	            .getSimpleName());
    ...
    public EvaluacionInfraestructuraController() {
	...
	try {
	    ...
	    listaVariablesInfraestructura = evaluacionServicio
		    .obtenerInformacionVariablesActivas("INF",
	...
	LOG.info(new Date() + "--> Inicializando criterios");
	...
	try {
		...
		if ((vvdto.getValor() != null && !vvdto.getValor().equals(
		    ...
		    vvdto.setValorVerificado(Double.parseDouble(vvdto
			    .getValor()));
		    modificado = true;
